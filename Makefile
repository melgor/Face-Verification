...
CFLAGS=-c -Wall -std=c++0x -g3 -Ofast -msse2  -I. -I/home/blcv/CODE/Face_LIB/dlib-18.12/ -I /home/blcv/LIB/yaml-cpp-0.5.1/include/ \
      -I/home/blcv/LIB/caffe_bn/include/ -I/home/blcv/LIB/caffe_bn/src/ -I/usr/local/cuda/include $(DEBUG) 
LDFLAGS=-L/usr/local/lib -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_features2d -lopencv_calib3d -lopencv_nonfree -lopencv_flann -lopencv_objdetect -lopencv_video\
